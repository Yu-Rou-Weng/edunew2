# rtsp://root:pcs54784@140.113.131.67:554/live2.sdp
Power = 0
# 以上變數讀取感測器後會自動更新
...
def on_Power(data):
    global Luminance1, Luminance2
    if data < 3:
        Luminance1 = Luminance2 = 0
    elif data < 6:
        Luminance1 = 1
        Luminance2 = 0
    else:
        Luminance1 = Luminance2 = 1
    update_info()
